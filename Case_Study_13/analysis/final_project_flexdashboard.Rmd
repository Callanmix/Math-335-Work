...
Maps of Suicide Around the World
==================

### Interative Map Showing Suicides for Every 100,000 People
...
ggplot() +
  ...
  labs(title = "Sum of Suicides 1990")
...
ggplot() +
  ...
  scale_fill_gradient(name = "Sum of Suicide", trans = "log")+
  labs(title = "Sum of Suicides 1995")
...
ggplot() +
  ...
  scale_fill_gradient(name = "Sum of Suicide", trans = "log") +
  labs(title = "Sum of Suicides 2000")
...
ggplot() +
  ...
  scale_fill_gradient(name = "Sum of Suicide", trans = "log") +
  labs(title = "Sum of Suicides 2005")
...
ggplot() +
  ...
  scale_fill_gradient(name = "Sum of Suicide", trans = "log") +
  labs(title = "Sum of Suicides 2010")
...
ggplot() +
  ...
  scale_fill_gradient(name = "Sum of Suicide", trans = "log") +
  labs(title = "Sum of Suicides 2015")
```

Suicide Relationships
==================
### Sum of Suicide and Average Poplulation
...
### Relation of Literacy Rates to Suicide Rates
...
a <- lit_death %>% 
  ...
  labs(title = 'Year: {frame_time}', x = 'Literacy Rates %', y = 'Suicides as % of Total Deaths') +
...
### Suicide Rates er Every 100,000 People and GDP per Capita

```{r animate gdp/suicideper100}
